...
set myProject "test1_quartus"
set myProjectFile "test1_quartus.qpf"
set myTopLevelEntity "test1"
...
if { ! [ file exists $myProjectFile ] } {
    # Create new project
    puts "### Create new $myTool project <a href=\"matlab:downstream.handle('Model','test1').openTargetTool;\">hdl_prj\\quartus_prj\\test1_quartus.qpf</a>"
    load_package flow
    project_new $myProject

} else {
    # Open existing project
    puts "### Open existing $myTool project <a href=\"matlab:downstream.handle('Model','test1').openTargetTool;\">hdl_prj\\quartus_prj\\test1_quartus.qpf</a>"
    load_package flow
...
set_global_assignment -name VERILOG_FILE "../hdlsrc/test1/myCNT09.v"
set_global_assignment -name VERILOG_FILE "../hdlsrc/test1/test1.v"
set_global_assignment -name SDC_FILE "../hdlsrc/test1/clock_constraint.sdc"
