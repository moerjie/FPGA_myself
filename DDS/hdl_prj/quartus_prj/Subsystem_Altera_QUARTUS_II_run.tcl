...
set myProject "Subsystem_quartus"
set myProjectFile "Subsystem_quartus.qpf"
set myTopLevelEntity "Subsystem"
set Family "Cyclone III"
set Device "EP3C40F484C7"
set Package ""
set Speed ""
set UseTimeQuest "ON"
...
if { ! [ file exists $myProjectFile ] } {
    # Create new project
    puts "### Create new $myTool project <a href=\"matlab:downstream.handle('Model','NCO').openTargetTool;\">hdl_prj\\quartus_prj\\Subsystem_quartus.qpf</a>"
    load_package flow
    project_new $myProject

} else {
    # Open existing project
    puts "### Open existing $myTool project <a href=\"matlab:downstream.handle('Model','NCO').openTargetTool;\">hdl_prj\\quartus_prj\\Subsystem_quartus.qpf</a>"
    load_package flow
...
set_global_assignment -name TOP_LEVEL_ENTITY Subsystem
