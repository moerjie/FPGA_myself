// -------------------------------------------------------------
// 
// File Name: F:\Git_Repository\FPGA_myself\DDS\DDS_CSDN\FIR\hdlsrc\FIR\FilterTapSystolicPreAddWvlIn.v
...
// Source Path: FIR/Discrete FIR Filter/Filter/subFilter/FilterTapSystolicPreAddWvlIn
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAddWvlIn
  ...
  input   signed [16:0] dinPreAdd;  // sfix17
  input   signed [15:0] coefIn_0;  // sfix16_En16
  input   signed [43:0] addin;  // sfix44_En16
  input   dinRegVld;
  input   syncReset;
  output  signed [16:0] dinDly2;  // sfix17
  output  signed [43:0] tapout;  // sfix44_En16


  reg signed [16:0] fTap_din1_reg1;  // sfix17
  reg signed [16:0] fTap_din1_reg2;  // sfix17
  reg signed [16:0] fTap_din1_reg3;  // sfix17
  reg signed [16:0] fTap_din2_reg1;  // sfix17
  reg signed [16:0] fTap_din2_reg2;  // sfix17
  reg signed [43:0] fTap_addout_reg;  // sfix44
  reg signed [15:0] fTap_coef_reg1;  // sfix16
  reg signed [15:0] fTap_coef_reg2;  // sfix16
  reg signed [16:0] fTap_din1_reg1_next;  // sfix17
  reg signed [16:0] fTap_din1_reg2_next;  // sfix17
  reg signed [16:0] fTap_din1_reg3_next;  // sfix17
  reg signed [16:0] fTap_din2_reg1_next;  // sfix17
  reg signed [16:0] fTap_din2_reg2_next;  // sfix17
  reg signed [43:0] fTap_addout_reg_next;  // sfix44_En16
  reg signed [15:0] fTap_coef_reg1_next;  // sfix16_En16
  reg signed [15:0] fTap_coef_reg2_next;  // sfix16_En16
  reg signed [16:0] dinDly2_1;  // sfix17
  reg signed [43:0] tapout_1;  // sfix44_En16
  reg signed [17:0] fTap_add_temp;  // sfix18
  reg signed [33:0] fTap_mul_temp;  // sfix34_En16
  reg signed [43:0] fTap_add_cast;  // sfix44_En16
  reg signed [17:0] fTap_t_0_0;  // sfix18
  reg signed [17:0] fTap_t_1;  // sfix18

  initial begin
    fTap_din1_reg1 = 17'sb00000000000000000;
    fTap_din1_reg2 = 17'sb00000000000000000;
    fTap_din1_reg3 = 17'sb00000000000000000;
    fTap_din2_reg1 = 17'sb00000000000000000;
    fTap_din2_reg2 = 17'sb00000000000000000;
  ...
  always @(addin, coefIn_0, dinPreAdd, dinReg2_0_re, dinRegVld, fTap_addout_reg,
    ...
    fTap_add_temp = 18'sb000000000000000000;
    fTap_mul_temp = 34'sh000000000;
    fTap_t_0_0 = 18'sb000000000000000000;
    fTap_t_1 = 18'sb000000000000000000;
    fTap_add_cast = 44'sh00000000000;
    ...
    if (dinRegVld) begin
      fTap_t_0_0 = {fTap_din1_reg3[16], fTap_din1_reg3};
      fTap_t_1 = {fTap_din2_reg2[16], fTap_din2_reg2};
      fTap_add_temp = fTap_t_0_0 + fTap_t_1;
      fTap_mul_temp = fTap_add_temp * fTap_coef_reg2;
      fTap_add_cast = {{10{fTap_mul_temp[33]}}, fTap_mul_temp};
