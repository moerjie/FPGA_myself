...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = fir_test_mlab_mat (stimulation, output)
	coef_matrix=[-172 -182 -119 0 136 238 258 174 0 -212 -387 -442 -319 0 478 1032 1549 1914 2047 1914 1549 1032 478 0 -319 -442 -387 -212 0 174 258 238 136 0 -119 -182 -172 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
