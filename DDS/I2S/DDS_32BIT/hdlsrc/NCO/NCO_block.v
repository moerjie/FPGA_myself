// -------------------------------------------------------------
// 
// File Name: F:\Git_Repository\FPGA_myself\DDS\DDS_CSDN\DDS_32BIT\hdlsrc\NCO\NCO_block.v
...
module NCO_block
  ...
  wire signed [31:0] const0;  // sfix32
  wire signed [31:0] pInc;  // sfix32
  wire signed [31:0] validPInc;  // sfix32
  reg signed [31:0] accphase_reg;  // sfix32
  wire signed [31:0] addpInc;  // sfix32
  wire signed [31:0] pOffset;  // sfix32
  wire signed [31:0] accoffset;  // sfix32
  reg signed [31:0] accoffsete_reg;  // sfix32
  wire [3:0] dither;  // ufix4
  wire signed [31:0] casteddither;  // sfix32
  reg signed [31:0] dither_reg;  // sfix32
  wire signed [31:0] accumulator;  // sfix32
  wire [11:0] accQuantized;  // ufix12_E20
  ...
  assign casteddither = {28'b0, dither};
