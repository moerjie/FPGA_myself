-- -------------------------------------------------------------
-- 
-- File Name: F:\Git_Repository\FPGA_myself\DDS\DDS_CSDN\DDS_32BIT\hdlsrc\NCO\NCO_block.vhd
...
ARCHITECTURE rtl OF NCO_block IS
  ...
  SIGNAL accQuantized                     : unsigned(11 DOWNTO 0);  -- ufix12_E20
...
BEGIN
  ...
  u_Wave_inst : WaveformGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              phaseIdx => std_logic_vector(accQuantized),  -- ufix12_E20
  ...
  -- Phase quantization
  accQuantized <= unsigned(accumulator(31 DOWNTO 20));
