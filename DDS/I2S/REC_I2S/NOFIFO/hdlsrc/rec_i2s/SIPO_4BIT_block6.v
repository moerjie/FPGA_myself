// -------------------------------------------------------------
// 
// File Name: F:\Git_Repository\FPGA_myself\DDS\I2S\REC_I2S\NOFIFO\hdlsrc\rec_i2s\SIPO_4BIT_block6.v
...
// Source Path: rec_i2s/REC_I2S_NOFIFO/SIPO_32BIT_R1/Subsystem/SIPO_16BIT1/SIPO_8BIT1/SIPO_4BIT
// Hierarchy Level: 5
// Model version: 1.40
// 
// -------------------------------------------------------------
...
module SIPO_4BIT_block6
  ...
  alpha2BIT_SIPO_block13 u_2BIT_SIPO (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .SERIAL_IN(SERIAL_IN),
  ...
  alpha2BIT_SIPO1_block13 u_2BIT_SIPO1 (.clk(clk),
                                        .reset(reset),
                                        .enb(enb),
